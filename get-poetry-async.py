...
def get_poetry(sockets):
    ...
    while sockets:
        ...
        print '\t socket:{}, rlist: {}'.format(sockets, rlist)
        ...
        for sock in rlist:
            ...
            while True:
                ...
                try:
                    ...
                    if e.args[0] == errno.EWOULDBLOCK:
                        ...
                        print '{} error, cycle {}.'.format(sock2task[sock], cc)
                        break
                    raise
                else:
                    print 'not breaked, cycle{}'.format(cc)
                    if not new_data:
                        break
                    else:
                        data += new_data
            ...
            if not data:
                ...
                print 'Task %d: got %d bytes of poetry from %s' % (task_num, len(data), addr_fmt)
